...
window.onload = function() {   
  ...
  /*frame one*/ 
  .add("frame1")
  .from(".bg1, .product1, .sale1", 1, { x:-385,ease:Back.easeOut.config(.9)}, "frame1")
  .from(".dell_logo, .vendor_logo, .frm-1-text", .5, {alpha:0,ease:Linear.easeInOut}, "frame1+=0.3")
  ...
  .from(".bg2, .product2", 1, { x:-385,ease:Back.easeOut.config(.9)}, "frame2")
  ...
  .from(".bg3, .product3", 1, { x:-385,ease:Back.easeOut.config(.9)}, "frame3")
  ...
  .from(".bg4, .product4", 1, { x:-385,ease:Back.easeOut.config(.9)}, "frame4")
  ...
  .from(".bg5, .product5, .sale2", 1, { x:-385,ease:Back.easeOut.config(.9)}, "frame5")
  ...
  // /*frame five*/
  // .add("frame6","frame5+=2.25")

  // .from(".cta, .price-mainbox,.frm-6-text, .dell_logo2,.vendor_logo2, .product5", .5, {alpha:0, ease:Linear.easeInOut}, "frame6")
